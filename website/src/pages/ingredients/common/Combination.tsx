      ...
      <div className="w-full mt-10 gap-2 flex flex-col">
        <div className="w-full py-5">
          ...
          <span className="inline-flex items-center px-4 py-1 rounded-md bg-gray-200 text-sm">
            combination({<em>total number of elements{('<number>')}</em>},&nbsp;&nbsp;<em>number of elements to be selected{('<number>')}</em>)
          </span>
          <p className="mt-5">
            ...
            elements. The time complexity depends on the size of the combination
            to be calculated.
          </p>
        </div>
