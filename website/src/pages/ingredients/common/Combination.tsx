...
export default function Combination() {
  return (
    <HelmetWrapper title="Combination" description="combination calculation">
      <div className="w-full flex flex-col mb-20">
        <h2 className="text-4xl font-bold mb-3">Combination</h2>
        ...
        <div className="w-full mt-10 gap-2 flex flex-col">
          <div className="w-full py-5">
            ...
            <span className="inline-flex items-center px-4 py-1 rounded-md bg-gray-200 text-sm">
              combination({<em>total number of elements{"<number>"}</em>}
              ,&nbsp;&nbsp;
              <em>number of elements to be selected{"<number>"}</em>)
            </span>
            <p className="mt-5">
              This function calculates combination based on the given n and r
              values and returns the result. Combination represents how many
              different ways you can select r unordered elements from a set of n
              elements. The time complexity depends on the size of the
            ...
            <div className="flex w-full justify-between items-center px-2 py-1 bg-gray-700">
              ...
              <Button
                ...
                onClick={() =>
                  handleCopyClick(
                    `
        import {combination} from 'calculation-toolkit';
        ...
        `
            ...
            <div className="w-full px-5 py-4 flex flex-col gap-2">
              <pre className="text-sm font-medium">
                <code className="text-blue-700">import</code> {"{combination}"}
              ...
              <pre className="text-sm font-medium mt-5">
                ...
                <br />
                <code className="text-red-700">combination</code>(
        ...
        <ActionDoubleButton
          firstName="Combine Mean"
          firstPath="combine-mean"
          secondName="Permutation"
          secondPath="permutation"
        />
      </div>
    </HelmetWrapper>
  );
