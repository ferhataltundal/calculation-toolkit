...
export default function Factorial() {
  return (
    <HelmetWrapper title="Factorial" description="factorial calculation">
        ...
        <div className="w-full mt-10 gap-2 flex flex-col">
          <div className="w-full py-5">
            ...
            <p className="mt-5">
              ...
              returns the result. The factorial of a number is the product of
              all positive integers less than or equal to that number. Factorial
              is defined only for non-negative integers. For non-integer values
              or negative numbers, the factorial is not defined. The time
              complexity of this function is O(n), where n is the value of the
              input number.
            </p>
          </div>
