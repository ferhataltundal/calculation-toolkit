...
export default function Mode() {
  return (
    <HelmetWrapper title="Mode" description="mode calculation">
        ...
        <div className="w-full mt-10 gap-2 flex flex-col">
          <div className="w-full py-5">
            ...
            <p className="mt-5">
              ...
              frequency), all modes are returned. If there is no mode (all
              values occur with the same frequency), an empty array is returned.
            </p>
          </div>
