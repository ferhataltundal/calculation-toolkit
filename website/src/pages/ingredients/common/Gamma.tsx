...
export default function Gamma() {
  return (
    <HelmetWrapper title="Gamma" description="gamma calculation">
        ...
        <div className="w-full mt-10 gap-2 flex flex-col">
          <div className="w-full py-5">
            ...
            <p className="mt-5">
              ...
              t^(x-1) * e^(-t) dt. It uses a numerical integration approach with
              a specified step size and a maximum number of iterations.
              Increasing the number of iterations improves the calculation
              accuracy. The time complexity depends on the length of the
              integral range and the number of iterations.
            </p>
          </div>
