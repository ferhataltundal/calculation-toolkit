...
export default function HarmonicMean() {
  return (
    <HelmetWrapper
      title="Harmonic Mean"
      description="harmonic mean calculation"
    >
        ...
        <div className="w-full mt-10 gap-2 flex flex-col">
          <div className="w-full py-5">
            ...
            <p className="mt-5">
              ...
              numbers and returns the result. Harmonic mean is the average of
              the reciprocals of the numbers. Harmonic mean cannot be calculated
              for arrays containing negative or zero values. The time complexity
              is linear with respect to the length of the array, O(n).
            </p>
          </div>
