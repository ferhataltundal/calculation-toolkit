...
export default function Min() {
  return (
    <div className="w-full flex flex-col mb-20">
      <h2 className="text-4xl font-bold mb-3">Min</h2>
      ...
      <div className="w-full mt-10 gap-2 flex flex-col">
        <div className="w-full py-5">
          ...
          <span className="inline-flex items-center px-4 py-1 rounded-md bg-gray-200 text-sm">
            min({<em>array{"<number>"}</em>})
          </span>
          <p className="mt-5">
            This function finds the minimum value in the given array and returns
            it. The time complexity is linear with respect to the length of the
            array, O(n).
          </p>
        </div>
          ...
          <div className="flex w-full justify-between items-center px-2 py-1 bg-gray-700">
            ...
            <Button
              ...
              onClick={() =>
                handleCopyClick(
                  `
  import {min} from 'calculation-toolkit';
  ...
  `
          ...
          <div className="w-full px-5 py-4 flex flex-col gap-2">
            <pre className="text-sm font-medium">
              <code className="text-blue-700">import</code> {"{min}"}
            ...
            <pre className="text-sm font-medium mt-5">
              ...
              <br />
              <code className="text-red-700">min</code>(
              {<code className="text-green-800">[5, 2, 9, 1, 8]</code>}
              ); <code className="text-gray-500">{"//1"}</code>
            </pre>
          </div>
        </div>
      </div>
