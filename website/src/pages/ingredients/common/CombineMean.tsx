      ...
      <div className="w-full mt-10 gap-2 flex flex-col">
        <div className="w-full py-5">
          ...
          <span className="inline-flex items-center px-4 py-1 rounded-md bg-gray-200 text-sm">
            ...
            {<em>size1{"<number>"}</em>}&nbsp;&nbsp;
            {<em>mean2{"<number>"}</em>}&nbsp;&nbsp;{<em>size2{"<number>"}</em>}
            )
          </span>
          <p className="mt-5">
            This function takes the means and sizes of two datasets and combines
            them to compute the weighted average mean. It is useful when you
            want to calculate the overall mean of two datasets while taking
            their sample sizes into account.
          </p>
        </div>
