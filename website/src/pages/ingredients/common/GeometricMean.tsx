      ...
      <div className="w-full mt-10 gap-2 flex flex-col">
        <div className="w-full py-5">
          ...
          <p className="mt-5">
            ...
            elements. Geometric mean cannot be calculated for arrays containing
            negative or zero values. The time complexity is linear with respect
            to the length of the array, O(n).
          </p>
        </div>
        <div className="w-full bg-gray-200 rounded-md flex items-center justify-between flex-col overflow-hidden">
          ...
          <div className="w-full px-5 py-4 flex flex-col gap-2">
            <pre className="text-sm font-medium">
              <code className="text-blue-700">import</code> {"{geometricMean}"}
