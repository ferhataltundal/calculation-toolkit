...
export default function Installation() {
  return (
    <HelmetWrapper title="Installation" description="installation">
      <div className="w-full flex flex-col mb-20">
        ...
        <div className="w-full mt-10 gap-2 flex flex-col">
          ...
          <p>
            ...
            of Node.js installed on your system. If Node.js is not installed,
        ...
        <div className="w-full mt-10 gap-2 flex flex-col">
          ...
          <div className="w-full py-5">
            ...
            relevant sections of the documentation to discover other functions
            and features the library offers.
          </div>
        </div>
