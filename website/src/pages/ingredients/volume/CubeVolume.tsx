...
export default function CubeVolume() {
  return (
    <HelmetWrapper title="Cube Volume" description="cube volume calculation">
      <div className="w-full flex flex-col mb-20">
        <h2 className="text-4xl font-bold mb-3">Cube Volume</h2>
          ...
          <div className="w-full bg-gray-200 rounded-md flex items-center justify-between flex-col overflow-hidden">
            <div className="flex w-full justify-between items-center px-2 py-1 bg-gray-700">
              ...
              <Button
                ...
                onClick={() =>
                  handleCopyClick(
                    `
                    import {cubeVolume} from 'calculation-toolkit';
            ...
            <div className="w-full px-5 py-4 flex flex-col gap-2">
              <pre className="text-sm font-medium">
                <code className="text-blue-700">import</code> {"{cubeVolume}"}
              ...
              <pre className="text-sm font-medium mt-5">
                ...
                <br />
                <code className="text-red-700">cubeVolume</code>(
                {<code className="text-green-800">4</code>}
                ); <code className="text-gray-500">{"//64"}</code>
              </pre>
            </div>
          </div>
        </div>
        <ActionDoubleButton
          firstName="Cone Volume"
          firstPath="cone-volume"
          secondName="Cuboid Volume"
          secondPath="cuboid-volume"
        />
      </div>
    </HelmetWrapper>
  );
